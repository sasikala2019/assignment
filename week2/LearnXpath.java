...
WebElement findElement = driver.findElement(By.xpath("//input[@type='username']"));
...
WebElement eleMarkCompaign = driver.findElement(By.id("createLeadForm_Marketing CampaignEnumId "));
